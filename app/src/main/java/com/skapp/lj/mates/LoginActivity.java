...
public class LoginActivity extends BaseActivity implements
    ...
    private FirebaseAuth.AuthStateListener mAythListener;
    ...
    public void onStart() {
        super.onStart();
        mAuth.addAuthStateListener(mAythListener);
    }
    ...
    public void onStop() {
        super.onStop();
        if (mAythListener != null) {
            mAuth.removeAuthStateListener(mAythListener);
        }
    }
